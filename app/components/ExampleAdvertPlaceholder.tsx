...
export default function ExampleAdvertPlaceholder({ className, style }: Props) {
  return (
    ...
    >
      <svg version="1.0" viewBox="0 0 64 64" style={{ width: '52%', height: 'auto', clipPath: 'inset(0 0 18% 0)' }} xmlns="http://www.w3.org/2000/svg">
        <g>
          <g>
